...
### configure ###########
JULIUS_HOME		= "~/Software/julius/."
JULIUS_EXEC		= "~/Software/julius/julius -C ~/Software/julius/dictation-kit-4.5/am-gmm.jconf -C ~/Software/julius/dictation-kit-4.5/main.jconf -input file -outfile"
SERVER_PORT 	= 8000
ASR_FILEPATH	= '~/Software/julius/Public/asr/'
ASR_IN			= 'ch_asr.wav'
